...
Original file is located at
    https://colab.research.google.com/drive/1KhaBlMvshg6lkQEdxhZfT0y0NY_BvDZ2
"""
...
class DQNLightning(LightningModule):
    def __init__(
        ...
        self.env = gym.make(self.hparams.env, render_mode="rgb_array")
    ...
    def get_device(self, batch) -> str:
        ...
        return batch[0].device.index if self.on_gpu else 0 # 'cpu'?

model = DQNLightning(episode_length=200)

trainer = Trainer(
    accelerator="auto",
    devices=1 if torch.cuda.is_available() else 'auto',  # limiting got iPython runs
    max_epochs=500,
